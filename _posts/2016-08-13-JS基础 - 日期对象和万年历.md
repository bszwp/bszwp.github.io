...
<body>
	<script type="text/javascript">
		...
		var d2 = new Date(2016, 11, 31, 8, 6, 50);
		console.log(d2);	//Sat Dec 31 2016 08:06:50 GMT+0800 (中国标准时间)
	</script>
</body>
```
...
```javascript
var date1 = new Date("2016-6-8");
var date2 = new Date(0);
alert(date1-date2);  //返回毫秒数 跟date1.getTime()一样
```

## Date.parse()

```javascript
var num = Date.parse("2016-6-8");
alert(num);
```
