...
**补充：由于上述都是节点操作，所以获取到的节点会包含一些我们并不关心的内容，比如空节点。下面的几个api值获取元素节点。**
...
## 5.2	setAttribute(attributename,attributevalue): 设置属性值
